...
> 
> Ne vous inquiétez pas si vous n'arriver pas à cocher la case : **< $data source >** dans **< Query Options>**, il peut afficher **< Prometheus >** par défaut.
> ![](http://93.90.205.194/docs/bbb-dashboard/query-datasource-old.png)  
---
